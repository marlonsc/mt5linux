...
This module provides TypedDict definitions and type aliases for
MetaTrader 5 data structures returned by the API.
"""
...
VersionTuple = tuple[int, int, str]
...
class MT5LastError(NamedTuple):
    """MT5 last error information."""
