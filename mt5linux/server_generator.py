"""
server_generator.py - RPyC Server Script Generator for MetaTrader5 Integration

Utility to generate the RPyC server script for MetaTrader5 integration. For absolute imports to work, run with:
...
def generate_rpyc_server_script(fname: str) -> None:
    ...
    :param fname: Path to the file where the server script will be written.
    :type fname: str
    :rtype: None
...
from rpyc.utils.registry import REGISTRY_PORT, UDPRegistryClient, TCPRegistryClient
